...
router.get("/fucntion-void", (req: Request, res: Response, next: NextFunction) => {
  deposit(100);
  res.send(`deposit`);
});
...
let score: any = 10;
let unknownScore: unknown = "45";
let overallScore1: string = score;
let overallScore2: number = unknownScore as number;
